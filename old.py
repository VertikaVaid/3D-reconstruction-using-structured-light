...
def reconstruct_from_binary_patterns():
    ...
    #colour_image = cv2.resize(cv2.imread("images/pattern000.jpg", cv2.IMREAD_GRAYSCALE), (0,0), fx=scale_factor,fy=scale_factor)
    ...
    for x in range(w):
        for y in range(h):
            ...
            #b = colour_image[scan_bits[y, x, 0]]
            #g = colour_image[scan_bits[y, x, 1]]
            #r = colour_image[scan_bits[y, x, 2]] 
            ...
            red_channel[y,x] = (x_p / 1280.0)*255
            green_channel[y,x] = (y_p / 800.0)*255
    ...
    output_name = sys.argv[1] + "correspondences.jpg"
